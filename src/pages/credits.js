      ...
      <Container className="text-left">
        ...
        <div style={{ maxHeight: "15em", lineHeight: "2em", overflow: "auto" }}>
          <ul>
            ...
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/15" target="_blank" rel="noreferrer">#15: Accessibility: Fix ARIA and accessible-name issues (Lighthouse reports)</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-24</span>
            </li>
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/14" target="_blank" rel="noreferrer">#14: Performance: Reduce main-thread work / JS bundle size</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-24</span>
            </li>
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/13" target="_blank" rel="noreferrer">#13: Bug: Browser errors logged to console during audits</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-24</span>
            </li>
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/12" target="_blank" rel="noreferrer">#12: Performance: Reduce LCP (12.6s on CI)</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-24</span>
            </li>
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/11" target="_blank" rel="noreferrer">#11: Content: Add content to Projects and Resume pages</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-15</span>
            </li>
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/10" target="_blank" rel="noreferrer">#10: Feature: Add fitness (Strava/Garmin) integration for posts</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-15</span>
            </li>
            <li>
            ...
            <li>
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/issues/8" target="_blank" rel="noreferrer">#8: Feature: Add 'Future' page under 'Now' and dropdown menu item functionality</a>
              <span style={{ display: 'inline-block', marginLeft: '0.5em', fontSize: '0.8em', color: '#444' }}>· opened 2025-12-15</span>
            </li>
            <li>
        ...
        <div style={{ maxHeight: "15em", lineHeight: "2em", overflow: "auto" }}>
          <ol reversed>
            ...
            <li>
              ...
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/commit/294aae0" target="_blank" rel="noreferrer">294aae0</a>
            </li>
            <li>
              <s>Add "Past Now" navigation / dropdown affordance - 2021-05-20</s> - {" "}
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/commit/6a1f68c" target="_blank" rel="noreferrer">6a1f68c</a>, {" "}
              <a href="https://github.com/nmpegetis/nbegetis.com-gatsby/commit/90170ae" target="_blank" rel="noreferrer">90170ae</a>
            </li>
          </ol>
        </div>
        ...
        <p>
          ...
          <a href="https://www.gatsbyjs.com/about/" target="_blank" rel="noreferrer">these people</a>.
          The source code of this site is available on GitHub. I developed this site based on{' '}
          <a href="https://www.gatsbyjs.com/starters/surudhb/gatsby-personal-site-template" target="_blank" rel="noreferrer">gatsby-personal-site-template</a> from{' '}
          <a href="https://github.com/surudhb" target="_blank" rel="noreferrer">Surudh Bhutani</a>.
        </p>

        <h3>License</h3>
        <p>This site’s simple license:</p>
        <p>You may copy the code of this site, and be inspired by its structure.</p>
        <p>You may not copy any content of mine and claim them as your own.</p>
